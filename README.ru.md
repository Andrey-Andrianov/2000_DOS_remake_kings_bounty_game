...
Для сохрания игры необходимо сперва сохранить игру нажав клавишу q, а затем сохранить текущее состояние DosBox нажав значок дискеты в левом верхнем углу. Текущее состояние сохраняется в LocalStorage браузера. Также для игры на мобильных устройствах удобно добавить страницу на экран домой устройства.
